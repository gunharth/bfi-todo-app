...
var articles = getLocalStorage(); // let main = document.querySelector("main");

var main = $("main"); // let eingabe = document.getElementById("todo-input");

var eingabe = $("#todo-input"); // let einfuegen = document.querySelector("#todo-add");

var einfuegen = $("#todo-add");
render(); // einfuegen.addEventListener("click", function(e) {
// einfuegen.click(function() {

einfuegen.on("click", function (e) {
  e.preventDefault();
  var value = eingabe.val();

  if (value != "") {
    articles.push(value); // eingabe.value = "";
...
function render() {
  ...
  for (var i = 0; i < articles.length; i++) {
    ...
    main.append($("<article> ".concat(articles[i], " </article>")));
  }
}
